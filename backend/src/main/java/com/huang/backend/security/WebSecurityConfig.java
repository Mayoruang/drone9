    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/drones/register", "/api/v1/drones/registration/**").permitAll()
                        .requestMatchers("/api/v1/admin/registrations/action").permitAll()
                        .requestMatchers("/api/v1/drones/management/**").permitAll()
                        .requestMatchers("/api/v1/drones/test/**").permitAll()
